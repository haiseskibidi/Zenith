...
Наш учебник разбит на 10 специализированных глав. Давай посмотрим, какие крутые темы и весёлые метафоры нас ждут впереди:
...
* **Чему научимся:** Переводу 2D мыши в 3D луч и кликам по Oriented Bounding Box через локальное AABB и `globalMatrix.invert()`. Физике упреждающего магнитного притяжения предметов с учетом скорости игрока. Изолированному нагреву костяшек рук и рабочей части инструментов.
...
10. **Глава 8 (Собеседования)**: Наш гоночный болид готов! Мы собираем все низкоуровневые трюки в мощнейшее резюме и учимся отвечать на сложнейшие вопросы BigTech-собеседований.
