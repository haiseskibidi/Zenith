...
- **ChunkRenderSystem.java**: Система отрисовки мира. (UPDATED) Реализует спаренный MDI-рендеринг (`opaqueBatches[2]`, `translucentBatches[2]`) и 100% Zero-Allocation обход видимости на примитивных плоских массивах без рантайм-аллокаций.
