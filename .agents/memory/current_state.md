...
- **Zenith Academy Portal (Vue 3 / Vite)**:
  ...
  - Реализован умный парсер разметки в `MarkdownRenderer.vue`: поддержка Prism.js для подсветки синтаксиса Java/GLSL, кастомных GitHub-алертов (`> [!NOTE]`), побитовых интерактивных виджетов и плавных скроллов.
